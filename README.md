...
Choose an action, watch the progress bar fill, collect resources, level up skills, unlock new recipes and areas, build your settlement from a campfire into a thriving village.

## Core Gameplay Loop

1. **Choose an action** — chop wood, mine stone, forage, craft, explore
2. **Wait for progress** — actions run automatically on a timer
...
Each gathering action (woodcutting, mining, foraging, etc.) has an associated skill. As skill levels increase:

- New rare drops become available
- Action speed increases
- Drop chances improve for rare items
- New recipes unlock
- Related actions unlock (e.g. high woodcutting unlocks bark stripping)

## Early Game Progression

The early game focuses on primitive technology and bootstrapping basic infrastructure:
...
- **Basic crafting** — stone tools, crude axes, simple containers
- **Fire-making** — build campfires, then hearths and bonfires
- **Clay work** — dig clay, shape pots, build firing pits and simple kilns
- **Drying and curing** — dry racks for preserving meat and hides
...
- **Campfire → Hearth → Bonfire** — cooking, warmth, crafting stations
