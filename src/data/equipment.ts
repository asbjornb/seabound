...
export const EQUIPMENT_ITEMS: Record<string, EquipmentItemDef> = {
  ...
  tidecallers_shell: {
    ...
    slot: "offhand",
    baseStats: [{ stat: "defense", value: 8 }, { stat: "wetResist", value: 10 }, { stat: "life", value: 20 }],
    requiredSkills: [{ skillId: "combat", level: 3 }],
    tier: 1,
    unique: true,
    fixedAffixes: [
      { affixId: "affix_tideborn", rollValue: 1.0 },
      { affixId: "affix_vital", rollValue: 0.9 },
    ],
    maxAffixes: 2,
    tags: ["stone", "shield"],
  },
  ...
  drowned_kings_crown: {
    ...
    slot: "head",
    baseStats: [{ stat: "defense", value: 14 }, { stat: "life", value: 35 }, { stat: "speed", value: -4 }],
    requiredSkills: [{ skillId: "combat", level: 4 }],
    tier: 2,
    unique: true,
    fixedAffixes: [
      { affixId: "affix_stoneheart", rollValue: 1.0 },
      { affixId: "affix_juggernaut", rollValue: 0.9 },
    ],
    maxAffixes: 2,
    tags: ["metal", "armor"],
  },
