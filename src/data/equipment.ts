...
export const AFFIXES: Record<string, AffixDef> = {
  ...
  affix_padded: {
    ...
    name: "Padded",
    family: "defense",
    description: "Cushioned layer absorbs impact and improves survivability.",
    modifiers: [{ stat: "defense", value: 7 }, { stat: "life", value: 4 }],
    rollRange: { min: 0.5, max: 1.0 },
  ...
  affix_pocketed: {
    ...
    name: "Pocketed",
    family: "utility",
    description: "Well-fitted with room to move. Improves stamina and agility on long treks.",
    modifiers: [{ stat: "endurance", value: 4 }, { stat: "speed", value: 3 }],
    rollRange: { min: 0.6, max: 1.0 },
    allowedSlots: ["body", "legs"],
  },
  // Endurance family
...
export const EQUIPMENT_ITEMS: Record<string, EquipmentItemDef> = {
  ...
  vine_wrapped_helm: {
    id: "vine_wrapped_helm",
    name: "Vine-Wrapped Helm",
    description: "A cracked stone helm held together with creeping vines. Found in the coastal ruins.",
    slot: "head",
    baseStats: [{ stat: "defense", value: 2 }, { stat: "life", value: 5 }],
    tier: 0,
    maxAffixes: 1,
    tags: ["stone", "armor"],
  },
  tattered_leggings: {
    ...
    name: "Tattered Explorer's Leggings",
    description: "Salvaged cloth leggings from a previous explorer. Frayed but still wearable.",
    slot: "legs",
    baseStats: [{ stat: "defense", value: 2 }, { stat: "speed", value: 1 }, { stat: "life", value: 3 }],
    tier: 0,
    maxAffixes: 1,
    tags: ["fiber", "armor"],
  },
  ...
  iron_sword: {
    id: "iron_sword",
    name: "Iron Sword",
    description: "A double-edged iron blade. Harder and keener than bronze — a weapon fit for the wilds.",
    slot: "weapon",
    baseStats: [{ stat: "offense", value: 26 }, { stat: "speed", value: 2 }, { stat: "attackSpeed", value: 5 }],
    requiredSkills: [{ skillId: "combat", level: 7 }],
    tier: 3,
    maxAffixes: 3,
    tags: ["metal", "weapon"],
  },
  iron_shield: {
    id: "iron_shield",
    name: "Iron Shield",
    description: "A round shield faced with wrought iron. Withstands blows that would shatter bronze.",
    slot: "offhand",
    baseStats: [{ stat: "defense", value: 18 }, { stat: "speed", value: -3 }, { stat: "life", value: 22 }],
  ...
  iron_helm: {
    id: "iron_helm",
    name: "Iron Helm",
    description: "A riveted iron helmet with a nasal guard. Keeps your skull in one piece.",
    slot: "head",
    baseStats: [{ stat: "defense", value: 11 }, { stat: "coldResist", value: 5 }, { stat: "life", value: 15 }],
    requiredSkills: [{ skillId: "combat", level: 6 }],
    tier: 3,
    maxAffixes: 3,
    tags: ["metal", "armor"],
  ...
  iron_cuirass: {
    id: "iron_cuirass",
    name: "Iron Cuirass",
    description: "Overlapping iron plates riveted to a leather backing. Heavy, unyielding protection.",
    slot: "body",
    baseStats: [{ stat: "defense", value: 18 }, { stat: "endurance", value: 4 }, { stat: "life", value: 30 }],
    requiredSkills: [{ skillId: "combat", level: 7 }],
    tier: 3,
    maxAffixes: 3,
    tags: ["metal", "armor"],
  ...
  iron_greaves: {
    id: "iron_greaves",
    name: "Iron Greaves",
    description: "Shaped iron shin guards strapped over leather. Solid leg protection for hard terrain.",
    slot: "legs",
    baseStats: [{ stat: "defense", value: 13 }, { stat: "speed", value: -1 }, { stat: "life", value: 18 }],
    requiredSkills: [{ skillId: "combat", level: 6 }],
    tier: 3,
    maxAffixes: 3,
    tags: ["metal", "armor"],
  ...
  iron_boots: {
    ...
    description: "Thick leather boots with iron toe caps and heel plates. Built for rough ground.",
    slot: "feet",
    baseStats: [{ stat: "defense", value: 9 }, { stat: "speed", value: 1 }, { stat: "wetResist", value: 5 }, { stat: "life", value: 10 }],
    requiredSkills: [{ skillId: "combat", level: 6 }],
    tier: 3,
    maxAffixes: 3,
    tags: ["metal", "armor"],
  ...
  steel_cuirass: {
    id: "steel_cuirass",
    name: "Steel Cuirass",
    description: "Articulated steel plates shaped to the body. The finest armor a castaway could forge.",
    slot: "body",
    baseStats: [{ stat: "defense", value: 22 }, { stat: "endurance", value: 5 }, { stat: "life", value: 38 }],
    requiredSkills: [{ skillId: "combat", level: 9 }],
    tier: 4,
    maxAffixes: 4,
    tags: ["metal", "armor"],
  ...
  steel_greaves: {
    id: "steel_greaves",
    name: "Steel Greaves",
    description: "Articulated steel leg armor. Full protection without sacrificing mobility.",
    slot: "legs",
    baseStats: [{ stat: "defense", value: 16 }, { stat: "speed", value: -1 }, { stat: "life", value: 22 }],
    requiredSkills: [{ skillId: "combat", level: 8 }],
    tier: 4,
    maxAffixes: 4,
    tags: ["metal", "armor"],
  ...
  steel_boots: {
    ...
    description: "Masterwork boots with articulated steel plating. Nimble despite the weight.",
    slot: "feet",
    baseStats: [{ stat: "defense", value: 11 }, { stat: "speed", value: 2 }, { stat: "wetResist", value: 6 }, { stat: "life", value: 12 }],
    requiredSkills: [{ skillId: "combat", level: 8 }],
    tier: 4,
    maxAffixes: 4,
    tags: ["metal", "armor"],
