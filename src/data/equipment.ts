...
export const EQUIPMENT_ITEMS: Record<string, EquipmentItemDef> = {
  ...
  fire_hardened_spear: {
    ...
    slot: "weapon",
    baseStats: [{ stat: "offense", value: 8 }, { stat: "speed", value: 1 }],
    tier: 0,
    maxAffixes: 1,
    tags: ["wood", "weapon"],
  },
  stone_club: {
    ...
    slot: "weapon",
    baseStats: [{ stat: "offense", value: 10 }, { stat: "speed", value: -2 }],
    tier: 0,
    maxAffixes: 1,
    tags: ["stone", "weapon"],
  },
  obsidian_dagger: {
    ...
    slot: "weapon",
    baseStats: [{ stat: "offense", value: 6 }, { stat: "speed", value: 3 }],
    tier: 0,
    maxAffixes: 2,
    tags: ["stone", "weapon"],
  },
  ...
  bronze_sword: {
    ...
    slot: "weapon",
    baseStats: [{ stat: "offense", value: 20 }, { stat: "speed", value: 2 }],
  ...
  bronze_shield: {
    ...
    slot: "offhand",
    baseStats: [{ stat: "defense", value: 14 }, { stat: "speed", value: -3 }],
  ...
  bronze_helm: {
    ...
    slot: "head",
    baseStats: [{ stat: "defense", value: 8 }, { stat: "coldResist", value: 4 }],
    requiredSkills: [{ skillId: "combat", level: 4 }],
    tier: 2,
    maxAffixes: 3,
    tags: ["metal", "armor"],
  ...
  bronze_cuirass: {
    ...
    slot: "body",
    baseStats: [{ stat: "defense", value: 14 }, { stat: "endurance", value: 3 }],
    requiredSkills: [{ skillId: "combat", level: 5 }],
    tier: 2,
    maxAffixes: 3,
    tags: ["metal", "armor"],
  ...
  bronze_greaves: {
    ...
    slot: "legs",
    baseStats: [{ stat: "defense", value: 10 }, { stat: "speed", value: -1 }],
    requiredSkills: [{ skillId: "combat", level: 4 }],
    tier: 2,
    maxAffixes: 3,
    tags: ["metal", "armor"],
  ...
  bronze_boots: {
    ...
    slot: "feet",
    baseStats: [{ stat: "defense", value: 7 }, { stat: "speed", value: 1 }, { stat: "wetResist", value: 4 }],
    requiredSkills: [{ skillId: "combat", level: 4 }],
    tier: 2,
    maxAffixes: 3,
    tags: ["metal", "armor"],
