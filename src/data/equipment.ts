...
export const EQUIPMENT_ITEMS: Record<string, EquipmentItemDef> = {
  ...
  fire_hardened_spear: {
    ...
    slot: "weapon",
    baseStats: [{ stat: "offense", value: 6 }, { stat: "speed", value: 2 }, { stat: "attackSpeed", value: 3 }],
    tier: 0,
    maxAffixes: 1,
    tags: ["wood", "weapon"],
  },
  stone_club: {
    ...
    slot: "weapon",
    baseStats: [{ stat: "offense", value: 8 }, { stat: "speed", value: -2 }, { stat: "attackSpeed", value: 1 }],
    tier: 0,
    maxAffixes: 1,
    tags: ["stone", "weapon"],
  },
  obsidian_dagger: {
    ...
    slot: "weapon",
    baseStats: [{ stat: "offense", value: 10 }, { stat: "durability", value: -5 }, { stat: "attackSpeed", value: 6 }],
    tier: 0,
    maxAffixes: 2,
    tags: ["stone", "weapon"],
  },
  ...
  palm_frond_hat: {
    ...
    slot: "head",
    baseStats: [{ stat: "heatResist", value: 5 }, { stat: "comfort", value: 2 }, { stat: "life", value: 4 }],
    tier: 0,
    maxAffixes: 1,
    tags: ["fiber", "armor"],
  },
