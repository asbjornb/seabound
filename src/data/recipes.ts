...
export const RECIPES: RecipeDef[] = [
  ...
  {
    id: "weave_palm_frond_hat",
    name: "Palm Frond Hat",
    description: "Weave palm fronds into a wide-brimmed hat. Shade from the tropical sun.",
    skillId: "weaving",
    panel: "craft",
    requiredSkillLevel: 2,
    inputs: [
      { resourceId: "palm_frond", amount: 3 },
      { resourceId: "rough_fiber", amount: 1 },
    ],
    equipmentOutput: "palm_frond_hat",
    durationMs: 6000,
    repeatable: true,
    xpGain: 12,
  },
  {
    id: "craft_hide_wraps",
    name: "Hide Wraps",
    description: "Bind strips of dried fiber around the legs. Protects against scrapes and thorns.",
    skillId: "weaving",
    panel: "craft",
    requiredSkillLevel: 2,
    inputs: [
